...
L = lipschitz_binary_neg_log_likelihood_regularized(X, y)
used = 1 / L
...
for res in results_large:
    loss_diff_large.append([cur_model.loss(*to_torch(X, y, x)) - smallest_loss for x in res.get_weights_over_time()[:100]])
