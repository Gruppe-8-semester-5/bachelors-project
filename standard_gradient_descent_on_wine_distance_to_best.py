...
for result in to_compare:
    result_accuracy = result.get_best_accuracy()
    if result_accuracy > best_accuracy:
        closest_distance = result_accuracy
...
descent_result_l44.set_most_accurate_weights(best_performer.get_most_accurate_weights())
descent_result_l46.set_most_accurate_weights(best_performer.get_most_accurate_weights())
descent_result_l47.set_most_accurate_weights(best_performer.get_most_accurate_weights())
descent_result_l48.set_most_accurate_weights(best_performer.get_most_accurate_weights())
...
plt.plot(x_values, descent_result_l44.get_best_weight_over_time_distances_to_best_weight(), label="a = 1/4400")
plt.plot(x_values, descent_result_l46.get_best_weight_over_time_distances_to_best_weight(), label="a = 1/4600")
plt.plot(x_values, descent_result_l47.get_best_weight_over_time_distances_to_best_weight(), label="a = 1/4700")
plt.plot(x_values, descent_result_l48.get_best_weight_over_time_distances_to_best_weight(), label="a = 1/4800")
